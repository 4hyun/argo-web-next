...
const CardWrapper = styled.div`
  ${tw`flex flex-col sm:flex-row xl:flex-col flex-grow shadow-lg xl:space-y-5 px-8 xl:px-10 py-10 rounded-xl focus:outline-none -ml-4! xl:(transition-transform duration-75 transform hover:(scale-110 z-20))`}
  & {
    flex-basis: 0;
  }
  &.lemon {
