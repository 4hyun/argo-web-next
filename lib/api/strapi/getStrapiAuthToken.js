 ...
 */
  ...
  if (isProduction && !PROD_STRAPI_AUTH) {
    if (PROD_STRAPI_AUTH in global) {
      console.log(`${TAG}/msg: reusing PROD_STRAPI_AUTH from global: ${global.PROD_STRAPI_AUTH}`)
  ...
  try {
    ...
    console.log(`${TAG}/msg: setting global[PROD_STRAPI_AUTH]: ${data.jwt}`)
